...
$APPLICATION->SetPageProperty("TITLE", "Новые продукты");
$APPLICATION->SetTitle("Новые продукты");
...
<?php if ($USER->IsAuthorized()): ?>
    ...
    $APPLICATION->IncludeComponent("bitrix:news.list", "page_new_products", Array(
...
<?php else: ?>
<p>Раздел станет доступен после авторизации.</p>
<?php endif; ?>
